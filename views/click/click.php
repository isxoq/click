...
<form id="click_form" action="https://my.click.uz/services/pay" method="get" target="_blank">
    ...
    <input type="hidden" name="merchant_id" value="13997"/>
    <input type="hidden" name="merchant_user_id" value="13997"/>
    <input type="hidden" name="service_id" value="13997"/>
    <input type="hidden" name="transaction_param" value="152"/>
